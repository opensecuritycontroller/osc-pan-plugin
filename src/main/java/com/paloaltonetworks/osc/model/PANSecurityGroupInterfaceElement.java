...
public class PANSecurityGroupInterfaceElement extends BaseIdNameObject implements ManagerSecurityGroupInterfaceElement {

    private Set<ManagerPolicyElement> policies;
    private String tag;
    private String managerSecurityGroupId;

    public PANSecurityGroupInterfaceElement(String id, String name, Set<ManagerPolicyElement> policies, String tag,
    ...
    public void addManagerPolicyElements(Set<ManagerPolicyElement> morePolicies) {
        this.policies.addAll(morePolicies);
    }
}
